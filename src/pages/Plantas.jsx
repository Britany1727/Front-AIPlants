    ...
    return (
        <>
            <div 
                ...
                className=" gap-3 w-90 h-70 bg-gradient-to-r from-green-200 to-blue-300 rounded-lg shadow-lg overflow-hidden cursor-pointer hover:shadow-xl transition-shadow duration-300 m-6"
            >
                <img 
            ...
            {isOpen && (
                ...
                >
                    ...
                    >
                        ...
                        <div className="bg-gradient-to-l from-emerald-200 to-indigo-200 p-6">
                            <img 
                                src="/planta-ejemplo.jpg" 
                                alt="Planta" 
